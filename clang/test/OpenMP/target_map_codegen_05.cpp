...
// CK6-32-NEXT:    [[DOTOFFLOAD_MAPPERS:%.*]] = alloca [1 x ptr], align 4
// CK6-64-NEXT:    [[GI_CASTED:%.*]] = alloca i64, align 8
...
// CK6-NEXT:    [[TMP2:%.*]] = getelementptr inbounds [1 x ptr], ptr [[DOTOFFLOAD_BASEPTRS]], i32 0, i32 0
// CK6-32-NEXT:    store i32 [[TMP1]], ptr [[TMP2]], align 4
// CK6-64-NEXT:    store i64 [[TMP1]], ptr [[TMP2]], align 8
// CK6-NEXT:    [[TMP3:%.*]] = getelementptr inbounds [1 x ptr], ptr [[DOTOFFLOAD_PTRS]], i32 0, i32 0
// CK6-32-NEXT:    store i32 [[TMP1]], ptr [[TMP3]], align 4
// CK6-32-NEXT:    [[TMP4:%.*]] = getelementptr inbounds [1 x ptr], ptr [[DOTOFFLOAD_MAPPERS]], i32 0, i32 0
// CK6-32-NEXT:    store ptr null, ptr [[TMP4]], align 4
...
// CK6-NEXT:    br label %[[OMP_OFFLOAD_CONT]]
...
// CK6-32-SAME: i32 noundef [[GI:%.*]]) #[[ATTR1:[0-9]+]] {
// CK6-64-SAME: i64 noundef [[GI:%.*]]) #[[ATTR1:[0-9]+]] {
// CK6-NEXT:  [[ENTRY:.*:]]
// CK6-32-NEXT:    [[GI_ADDR:%.*]] = alloca i32, align 4
// CK6-32-NEXT:    store i32 [[GI]], ptr [[GI_ADDR]], align 4
// CK6-64-NEXT:    [[GI_ADDR:%.*]] = alloca i64, align 8
// CK6-64-NEXT:    store i64 [[GI]], ptr [[GI_ADDR]], align 8
// CK6-NEXT:    [[TMP0:%.*]] = load i32, ptr [[GI_ADDR]], align 4
// CK6-NEXT:    [[INC:%.*]] = add nsw i32 [[TMP0]], 1
// CK6-NEXT:    store i32 [[INC]], ptr [[GI_ADDR]], align 4
// CK6-NEXT:    ret void
//
//
