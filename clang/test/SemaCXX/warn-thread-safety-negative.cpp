...
public:
  ...
  // A fact dropped at an unrelated join and re-added on the success edge is
  // not a new acquisition: the acquisition checks ran at the call and are
  // not repeated (no duplicate diagnostic at the TryLock).
