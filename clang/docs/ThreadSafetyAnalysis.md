...
already be held, and releasing the conditionally held capability warns that it
may not be held. A try-acquire of a capability that is already held adds a
