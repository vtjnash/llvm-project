...
;
; RUN: lli -jit-kind=orc-lazy -orc-lazy-debug=funcs-to-stdout -extra-module %s -extra-module %s \
...
; RUN:   -jd extra -extra-module %s -extra-module %s -jd main %S/Inputs/noop-main.ll | FileCheck %s
;
...
@f = private global %class.Foo zeroinitializer, align 1
...
@str4 = private global [26 x i8] c"Goodbye from __cxa_atexit\00"
@str5 = private global [20 x i8] c"Goodbye from atexit\00"


define internal void @_ZN3FooD1Ev(ptr nocapture readnone %this) unnamed_addr align 2 {
entry:
  %puts.i = tail call i32 @puts(ptr @str4)
  ret void
}

define internal void @atexit_handler() {
entry:
...
define internal void @printf_wrapper() {
entry:
